...
export default function AgentLive() {
  ...
  const { action, newMethAllocPct, confidence, reasoning, marketSnapshot, proposedAt, source } = decision
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{
              background: isLive ? 'var(--accent-soft)' : 'rgba(251, 191, 36, 0.10)',
              color: isLive ? 'var(--accent)' : '#fbbf24',
            }}
            title={isLive
              ? 'Reasoning generated by Claude Haiku 4.5 from live market data'
              : 'Fallback heuristic — set ANTHROPIC_API_KEY to enable Claude'}
          >
            {isLive ? 'AI: live' : 'AI: fallback'}
          </span>
        </div>
